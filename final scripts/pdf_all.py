...
if __name__ == "__main__":
    ...
    MODEL_NAME = "CNN_SKIP_CONNECTION-config-v5-msl-1979-2024-lookback3h-forecast2h-circular-norm-cnn-skip-empty_norm-max_pool-depth_8"
    MODEL_VERSION_TAG = "analysis_32"
    DL_BASE_DIRECTORY = f"/home/mansour/ML3300-24a/shreibshtein/DL-precipitation-prediction/model/{MODEL_NAME}"
    BASELINE_PRED_BASE_DIR = f"/home/mansour/ML3300-24a/shreibshtein/predictions_naive_32"
    ...
    CONTROL_FOLDS_VERSIONS = ['10', '11', '12', '13']
    PLOT_X_LIMITS = (-10, 10)
