...
if __name__ == '__main__':
    ...
    g = 9.80665 # Dividing the surface geopotential for orography
    ...
    variables = ['tcw', 'z']
    reanalysis_directories = ["/data/iacdc/ECMWF/ERA5/4xday_1.25_global_1000-200hPa/tpw/tpw_6hr_reanalysis_ERA5_",
    ...
    for file in file_paths:
        ...
        for v in range(len(variables)):
            ...
            for num in num_tracks:
                ...
                np.save(
                    "/data/iacdc/ECMWF/ERA5/OrTensors/" + var + "/" + year + "/" + file_name[0] + '_' + str(i),
                    tensor_p_storm)
